      ...
      <div className="mb-4">
        ...
        <div className="relative inline-block w-full sm:w-80">
          <select
            ...
            className="w-full appearance-none bg-white border border-slate-400 text-slate-700 py-2.5 px-4 pr-8 rounded-full leading-tight focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 cursor-pointer text-base overflow-ellipsis"
          >
