          ...
          <div className="relative bg-white rounded shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200 flex flex-col">
            ...
            <div className="p-8 space-y-8">
              ...
              <section>
                ...
                <p className="text-slate-700 text-sm leading-relaxed mb-4">
                  It is important to remember that the tool is not intended to project or predict the present or future value of an actual asset allocation, actual investments, or actual holdings in your account. This tool makes no assumptions about taxes and displays all results in gross (before tax) format.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-slate-700 text-sm leading-relaxed mb-4">
                  This tool uses data from a modeling engine which estimates the likelihood of a particular outcome based on an analysis of historical market data. The rounded estimates are expressed in <strong>real terms (adjusted for inflation)</strong> and are determined by running data through hypothetical market simulations.
                </p>
                <p className="text-slate-700 text-sm leading-relaxed mb-4">
                ...
                <ul className="list-disc pl-5 text-slate-700 text-sm leading-relaxed space-y-1 mb-4">
                  ...
                  <li>Monthly savings amount (assumed to grow with inflation)</li>
                ...
                <p className="text-slate-700 text-sm font-semibold">
                  IMPORTANT: The hypothetical asset projections do not factor in withdrawals from your Account during the accumulation phase.
                </p>
              </section>
            </div>
          </div>
